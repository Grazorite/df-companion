...
const badges = JSON.parse(readFileSync(BADGES_PATH, 'utf-8'))
let imagesAdded = 0
const missing = []
let notesCleaned = 0
...
writeFileSync(BADGES_PATH, JSON.stringify(badges, null, 2) + '\n', 'utf-8')
console.log(`✅ Images added: ${imagesAdded}`)
console.log(`⚠️  Missing images (${missing.length}): ${missing.join(', ')}`)
